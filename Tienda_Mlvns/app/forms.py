...
class CustomerRegistrationForm(UserCreationForm):
 ...
 password2 = forms.CharField(label= 'Confirmar Contraseña (Otra vez)', widget=forms.
                             PasswordInput(attrs={'class':'form-control'}))
...
class MyPasswordResetForm(PasswordResetForm):
 email = forms.EmailField(label=_("Correo"), max_length=254,
...
class MySetPasswordForm(SetPasswordForm):
 ...
 new_password2 = forms.CharField(label=_("Confirmar Nueva Contraseña"), strip=False, widget=forms.PasswordInput(attrs={'autocomplete':'new-password','class':'form-control'}))
